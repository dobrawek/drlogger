...
actual class SyslogLogListener actual constructor(
    ...
    companion object {
        private const val ANDROID_NOT_SUPPORTED = "Android is not supported"
    }
    ...
    actual override val name: String = TODO(ANDROID_NOT_SUPPORTED)
    actual override var enabled: Boolean = TODO(ANDROID_NOT_SUPPORTED)
    actual override var minLevel: ILogListener.Level = TODO(ANDROID_NOT_SUPPORTED)
    actual override var messageRegex: Regex? = null
    actual override var tagRegex: Regex? = TODO(ANDROID_NOT_SUPPORTED)

    actual override fun startListening(scope: CoroutineScope): Job {
        TODO(ANDROID_NOT_SUPPORTED)
    }
